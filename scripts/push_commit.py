...
PARENT_SHA = "1775f43857bd970b4480a810d81890195bd5755f"
...
def main():
    ...
    # 创建 commit
    commit_payload = {
        "message": "feat: 前端在线比对工作台 + 左右对照表格组件\n\n- ComparisonTable 组件：左右对照表格，颜色标记状态，展开详情\n- CorrectionPanel 组件：手动匹配/解除匹配/忽略对话框\n- WorkspacePage 重构为使用组件化架构\n- 前端构建通过",
        "tree": new_tree,
        "parents": [PARENT_SHA],
        "author": {"name": "XuYiming", "email": "1378936642@qq.com", "date": "2026-08-19T20:27:54+08:00"},
        "committer": {"name": "XuYiming", "email": "1378936642@qq.com", "date": "2026-08-19T20:27:54+08:00"},
    }
    ...
    def to_ts(d):
        dt = datetime.strptime(d["date"], "%Y-%m-%dT%H:%M:%SZ").replace(tzinfo=timezone.utc)
